...
doc.schemaVersion='1.3.0'; doc.lastObservedVersion=90; delete doc.pendingValidationVersion;
doc.sources=(doc.sources||[]).map(old=>{
 ...
 const next={...old,
   ...
   lastObservedVersion:90, pipelineStages:stages, pipelineSummary:summary, legacyHealthDeprecated:true
 };
