...
}
{
 ...
 assert.match(analyzer,/Array\.isArray\(directInfo\)/); assert.match(analyzer,/resolveUlsanEncryptedBoardFile/); assert.match(analyzer,/libreoffice-hwp-fallback/); assert.match(analyzer,/2\.5-confirmed-attachment-contracts/);
}
