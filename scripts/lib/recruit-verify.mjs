...
const ORG_RULES = {
  ...
  '울산광역시 타기관소식': { hosts: [/ulsan\.go\.kr$/i], url: [/bbs\/list\.(?:ulsan|do).*bbsId=BBS_0000000000000030/i], html: [/타기관\s*소식[\s\S]{0,8000}(?:총\s*게시물|번호[\s\S]{0,500}제목|bbsId.?BBS_0000000000000030)/i] },
