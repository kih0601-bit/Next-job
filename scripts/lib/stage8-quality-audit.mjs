export const STAGE8_QUALITY_AUDIT_VERSION = '1.2.0-actionable-closure-scope';
...
export function auditStage8Quality(report={}, {inputDiagnostics={}}={}) {
  ...
  const lowConfidenceSingles=[],singleDespiteMultiSignal=[],actionableMultiSplit=[],nonBlockingMultiSplit=[],requirementSignalWithoutEvidence=[],unreadRequiredSources=[],actionableUnreadSources=[],historicalUnreadSources=[],informationalUnreadSources=[],noEvidenceUnits=[];
