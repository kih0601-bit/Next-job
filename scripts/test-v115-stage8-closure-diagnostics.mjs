...
assert.match(VACANCY_SPLITTER_VERSION,/11\.(?:5|6)\.0/);
...
assert.equal(q.unreadDiagnostics.actionable,1);
assert.ok(q.structuralBlockers.includes('actionable-source-unreadable'));
